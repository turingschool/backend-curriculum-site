...
We will use Rails version 7.0.5 in Module 2 & 3.
...
If you get a message saying rails is not installed or you do not have version 7.0.5, run
...
If you instead get a version of Rails besides `7.0.5`, follow [these instructions](https://github.com/turingschool-examples/task_manager_rails/blob/master/rails_uninstall.md).
