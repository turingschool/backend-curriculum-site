...
* Summaries of at least 6 "cold outreach" contacts [submitted via email to Meg](mailto:mstewart@turing.io) on Tuesday 02/21. You are asked to complete two by the end of week 3, two by the end of week 4, and two by the end of week 5 with a summary of all emails submitted to Meg on 02/21 and including the following information. See this link for [guidelines](https://github.com/turingschool/professional_skills/blob/master/module_four/outreach_deliverable_guidelines.md)
