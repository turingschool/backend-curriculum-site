...
* What tool do you use in Ruby to manage dependencies in your projects?
* What are the benefits of using a tool to manage these dependencies?
* What tool is available to you in Rails to manage your static assets?
* What does Rails do to your static assets when you run `rake assets:precompile`?
* Are there similar tools that you've come across in JavaScript?
...
* Runs tasks for us automatically
