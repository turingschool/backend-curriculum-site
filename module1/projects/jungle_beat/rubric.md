...
-- | --- | --- | --- | ---
**Functionality** | Complete through iteration 4 and both extensions | Complete through Iteration 3 and functions as defined by the project requirements. | Up to Iteration 2 is complete or the application does not exactly follow the requirements outlined in the specification. | Iteration 2 is not complete. |
