...
# => #<Cell:0x0000000145b8f4e8 @column="A", @filled=false, @placement="A1", @row=1, @value=".">
pry(main)> a2 = board.columns[:A][1]
# => #<Cell:0x0000000145b8ee58 @column="A", @filled=false, @placement="A2", @row=2, @value=".">
pry(main)> a3 = board.columns[:A][2]
# => #<Cell:0x0000000145b8e7c8 @column="A", @filled=false, @placement="A3", @row=3, @value=".">
pry(main)> a4 = board.columns[:A][3]
# => #<Cell:0x0000000145b8e138 @column="A", @filled=false, @placement="A4", @row=4, @value=".">
pry(main)> a1.fill("X")
# => "X"
pry(main)> a2.fill("X")
# => "X"
pry(main)> a3.fill("X")
# => "X"
pry(main)> column_a = board.column_for(a3)
# => [#<Cell:0x0000000145b8f4e8 @column="A", @filled=true, @placement="A1", @row=1, @value="X">,
 #<Cell:0x0000000145b8ee58 @column="A", @filled=true, @placement="A2", @row=2, @value="X">,
 #<Cell:0x0000000145b8e7c8 @column="A", @filled=true, @placement="A3", @row=3, @value="X">,
 #<Cell:0x0000000145b8e138 @column="A", @filled=false, @placement="A4", @row=4, @value=".">,
 #<Cell:0x0000000145b8daa8 @column="A", @filled=false, @placement="A5", @row=5, @value=".">,
 #<Cell:0x0000000145b8d418 @column="A", @filled=false, @placement="A6", @row=6, @value=".">]
...
# => #<Cell:0x0000000145b8f3f8 @column="B", @filled=false, @placement="B1", @row=1, @value=".">
pry(main)> c1 = board.columns[:C][0]
# => #<Cell:0x0000000145b8f308 @column="C", @filled=false, @placement="C1", @row=1, @value=".">
pry(main)> d1 = board.columns[:D][0]
# => #<Cell:0x0000000145b8f218 @column="D", @filled=false, @placement="D1", @row=1, @value=".">
pry(main)> e1 = board.columns[:E][0]
# => #<Cell:0x0000000145b8f128 @column="E", @filled=false, @placement="E1", @row=1, @value=".">
pry(main)> b1.fill("O")
# => "O"
pry(main)> c1.fill("O")
# => "O"
pry(main)> d1.fill("O")
# => "O"
pry(main)> row_1 = board.row_for(e1)
# => [#<Cell:0x0000000145b8f4e8 @column="A", @filled=true, @placement="A1", @row=1, @value="X">,
 #<Cell:0x0000000145b8f3f8 @column="B", @filled=true, @placement="B1", @row=1, @value="O">,
 #<Cell:0x0000000145b8f308 @column="C", @filled=true, @placement="C1", @row=1, @value="O">,
 #<Cell:0x0000000145b8f218 @column="D", @filled=true, @placement="D1", @row=1, @value="O">,
 #<Cell:0x0000000145b8f128 @column="E", @filled=true, @placement="E1", @row=1, @value="O">,
 #<Cell:0x0000000145b8f038 @column="F", @filled=false, @placement="F1", @row=1, @value=".">,
 #<Cell:0x0000000145b8ef48 @column="G", @filled=false, @placement="G1", @row=1, @value=".">]
...
# => #<Cell:0x0000000145b8ed68 @column="B", @filled=false, @placement="B2", @row=2, @value=".">
pry(main)> c3 = board.columns[:C][2]
# => #<Cell:0x0000000145b8e5e8 @column="C", @filled=false, @placement="C3", @row=3, @value=".">
pry(main)> d4 = board.columns[:D][3]
# => #<Cell:0x0000000145b8de68 @column="D", @filled=false, @placement="D4", @row=4, @value=".">
pry(main)> b2.fill("X")
# => "X"
pry(main)> c3.fill("X")
# => "X"
pry(main)> diagonal = board.diagonal_for(d4)
# => [#<Cell:0x0000000145b8f4e8 @column="A", @filled=true, @placement="A1", @row=1, @value="X">,
 #<Cell:0x0000000145b8ed68 @column="B", @filled=true, @placement="B2", @row=2, @value="X">,
 #<Cell:0x0000000145b8e5e8 @column="C", @filled=true, @placement="C3", @row=3, @value="X">,
 #<Cell:0x0000000145b8de68 @column="D", @filled=false, @placement="D4", @row=4, @value=".">,
 #<Cell:0x0000000145b8d6e8 @column="E", @filled=false, @placement="E5", @row=5, @value=".">,
 #<Cell:0x0000000145b8cf68 @column="F", @filled=false, @placement="F6", @row=6, @value=".">]
